      ...
      <div className="planet-popup-content">
        ...
        <div className="planet-popup-main">
          ...
          <div className="planet-popup-details">
            <h2 className="planet-popup-name">{planet.name}</h2>
            <div className="planet-popup-stats-grid">
              <div className="stat-item">
                <h4 className="stat-label">ID:</h4>
                <p className="stat-value">{planet.id}</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Disposition:</h4>
                <p className="stat-value">{planet.disposition}</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Orbital period:</h4>
                <p className="stat-value">{planet.orbitalPeriod} days</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Transit epoch:</h4>
                <p className="stat-value">{planet.transitEpoch} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Transit duration:</h4>
                <p className="stat-value">{planet.transitDuration} hours</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Transit depth:</h4>
                <p className="stat-value">{planet.transitDepth} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Planetary radius:</h4>
                <p className="stat-value">{planet.planetaryRadius} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Equilibrium temperature:</h4>
                <p className="stat-value">{planet.equilibriumTemperature} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Insolation flux:</h4>
                <p className="stat-value">{planet.insolationFlux} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">TCE planet number:</h4>
                <p className="stat-value">{planet.tcePlanetNumber} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Stellar effective temperature:</h4>
                <p className="stat-value">{planet.stellarEffectiveTemperature} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Stellar surface gravity:</h4>
                <p className="stat-value">{planet.stellarSurfaceGravity} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Stellar radius:</h4>
                <p className="stat-value">{planet.stellarRadius} val.</p>
              </div>
              <div className="stat-item">
                <h4 className="stat-label">Magnitude:</h4>
                <p className="stat-value">{planet.magnitude} val.</p>
              </div>
            </div>
          </div>
        </div>
